...
if($rows>0){
	...
	$sql = "INSERT INTO `cart` (`product_id`,`product_img`,`product_name`,`product_num`,`product_price`,`product_attr`) VALUES ('$id','$img','$name','$num','$price','$attr')";
	/* print_r($sql); */
}
